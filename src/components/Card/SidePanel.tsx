          ...
          <RowContainer gap="md" padding="0 24px">
            <IconContainer size="lg">
              ...
              >
                ...
                <path
                  d="M57 32C57 36.9445 55.5338 41.778 52.7867 45.8893C50.0397 50.0005 46.1352 53.2048 41.5671 55.097C36.9989 56.9892 31.9723 57.4843 27.1227 56.5196C22.2732 55.555 17.8186 53.174 14.3223 49.6777C10.826 46.1814 8.445 41.7268 7.48037 36.8773C6.51574 32.0277 7.01082 27.0011 8.90301 22.4329C10.7952 17.8648 13.9995 13.9603 18.1107 11.2133C22.222 8.46622 27.0555 7 32 7V32H57Z"
                  stroke="#0B98E8"
                  stroke-width="4"
                  mask="url(#path-1-inside-1_279_1565)"
                />
                ...
                <path
                  d="M35 4C38.283 4 41.5339 4.64664 44.5671 5.90301C47.6002 7.15938 50.3562 9.00087 52.6777 11.3223C54.9991 13.6438 56.8406 16.3998 58.097 19.4329C59.3534 22.4661 60 25.717 60 29L35 29V4Z"
                  stroke="#0B98E8"
                  stroke-width="4"
                  mask="url(#path-2-inside-2_279_1565)"
                />
                <path
                  d="M35 9C37.6264 9 40.2272 9.51732 42.6537 10.5224C45.0802 11.5275 47.285 13.0007 49.1421 14.8579C50.9993 16.715 52.4725 18.9198 53.4776 21.3463C54.4827 23.7728 55 26.3736 55 29L35 29L35 9Z"
                  fill="#0B98E8"
                  fill-opacity="0.3"
                />
                <path
                  d="M52 32C52 35.9556 50.827 39.8224 48.6294 43.1114C46.4318 46.4004 43.3082 48.9638 39.6537 50.4776C35.9991 51.9913 31.9778 52.3874 28.0982 51.6157C24.2186 50.844 20.6549 48.9392 17.8579 46.1421C15.0608 43.3451 13.156 39.7814 12.3843 35.9018C11.6126 32.0222 12.0087 28.0009 13.5224 24.3463C15.0362 20.6918 17.5996 17.5682 20.8886 15.3706C24.1776 13.173 28.0444 12 32 12V32H52Z"
                  fill="#0B98E8"
                  fill-opacity="0.3"
                />
              </svg>
            ...
            <IconContainer size="lg">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M28.4803 39.4855C27.6063 39.8098 26.5916 39.667 25.9636 38.9779L10.8855 22.4328C10.1329 21.6069 10.2021 20.3266 11.112 19.6779C15.0048 16.9023 22.728 13 32 13C41.2721 13 48.9952 16.9023 52.8881 19.6779C53.7979 20.3266 53.8672 21.6069 53.1145 22.4328L38.0364 38.9779C37.4085 39.667 36.3937 39.8098 35.5197 39.4855C34.4235 39.0787 33.2377 38.8565 32 38.8565C30.7623 38.8565 29.5765 39.0787 28.4803 39.4855Z"
                  fill="#2DAF80"
                  fill-opacity="0.3"
                />
                <path
          ...
          <Clickable gap="md" padding="12px 24px">
            <IconContainer size="lg">
              ...
              >
                ...
                />
                <path
                  d="M19 33C19 33.5523 19.4477 34 20 34C20.5523 34 21 33.5523 21 33H19ZM19 11V33H21V11H19Z"
                  fill="#0B98E8"
                />
                <path
                  d="M25 28C25 28.5523 25.4477 29 26 29C26.5523 29 27 28.5523 27 28H25ZM25 11V28H27V11H25Z"
                  fill="#0B98E8"
                />
                <path
                  d="M31 39C31 39.5523 31.4477 40 32 40C32.5523 40 33 39.5523 33 39H31ZM31 11V39H33V11H31Z"
                  fill="#0B98E8"
                />
                <path
                  d="M58 32H6"
                ...
                />
                <path
                  d="M37 33C37 33.5523 37.4477 34 38 34C38.5523 34 39 33.5523 39 33H37ZM37 11V33H39V11H37Z"
                  fill="#0B98E8"
                />
                <path
                  d="M43 22C43 22.5523 43.4477 23 44 23C44.5523 23 45 22.5523 45 22H43ZM43 11V22H45V11H43Z"
                  fill="#0B98E8"
                />
              </svg>
            </IconContainer>
      ...
      <CardWrapper>
        <RowContainer gap="md" padding="24px 24px 0 24px">
          <IconContainer size="lg">
            ...
            >
              <path
                d="M12 21V45L32 55L52 45V21L32 9L12 21Z"
                fill="#A10BE8"
                fill-opacity="0.3"
              />
              <path
                d="M32 4L8 18.7925V47.3208M32 4L56 18.7925V47.3208M32 4V35.6981M8 47.3208L32 35.6981M8 47.3208L32 60L56 47.3208M32 35.6981L56 47.3208"
                stroke="#A10BE8"
                stroke-width="2"
              />
            </svg>
        ...
        <RowContainer justify="sb" padding="0 24px">
          ...
          <PrimaryButton width="fit-content" size="sm">
            <span>4</span>
            <span>more</span>
          </PrimaryButton>
        </RowContainer>
