    ...
    <Wrapper>
        <RowContainer width='fit-content'>
            <svg width="198" height="85" viewBox="0 0 198 85" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 78.8803L6.76471 83.5L14.8353 74.2606L18.2941 78.8803L26.3647 61.5563L29.8235 67.331L39.0471 69.6408L43.6588 78.8803L51.7294 51.162L56.3412 59.2465L60.9529 50.007L64.4118 52.3169L67.8706 44.2324L73.6353 47.6972L84.0118 31.5282L88.6235 38.4577L92.0824 33.838L95.5412 45.3873L103.612 47.6972L105.918 39.6127L109.376 50.007L112.835 34.993L120.906 28.0634L124.365 39.6127L128.976 34.993L132.435 44.2324L135.894 38.4577L139.353 53.4718L142.812 51.162L158.953 73.1056L164.718 56.9366L173.941 52.3169L179.706 37.3028L183.165 43.0775L187.776 25.7535L197 1.5" stroke="#2DAF80" stroke-width="2" stroke-linecap="round"/>
            </svg>
        </RowContainer>
        <ColumnContainer style={{flex: '60%'}} gap='sm'>
            ...
            <RowContainer padding='16px 0 0 0' justify='sb'>
                ...
                <Tag bg='#FFC8491A' color='#FFC849'>6Stocks</Tag>
            </RowContainer>
        </ColumnContainer>
    </Wrapper>
  )
